...
2.times do
    jobs.map { | job | 
        ...
        labor_category_ids = [] labor_category_id
        job.contractor_profile.contractor_specialties.map { | contractor_specialty | contractor_specialty.push(labor_category.id) }
